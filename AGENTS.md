...
- Action clients block on goal acceptance and then on the final result. The production client/server path does not use feedback or action cancellation; server callbacks should only mark goals succeeded or aborted.
